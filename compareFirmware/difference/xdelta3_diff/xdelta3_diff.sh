...
if [ $command = run ] || [ $command = all ]; then
    # samd20-xpro
    xdelta3 -e -s "../../database/${1}/samd20-xpro/${1}.bin" "../../database/${2}/samd20-xpro/${2}.bin" diff_bin_samd20
    ...
    # samd21-xpro
    xdelta3 -e -s "../../database/${1}/samd21-xpro/${1}.bin" "../../database/${2}/samd21-xpro/${2}.bin" diff_bin_samd21
...
echo Hint: diff can be reverted with xdelta3 -d -s.
echo Done!
